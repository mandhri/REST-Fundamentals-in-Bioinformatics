...
1. Looking up a gene by symbol (BRCA1)  
2. Fetching genomic sequences  
3. Exploring transcripts  
4. Querying a genomic region for overlapping genes  
5. Debugging with headers and listing available species  
6. Batch queries (symbols → Ensembl IDs → FASTA)  
...
Retrieve the genomic sequence of BRCA1 using its Ensembl ID.

- /sequence/id/{id} → fetches sequence by Ensembl ID

- type=genomic → genomic DNA sequence
