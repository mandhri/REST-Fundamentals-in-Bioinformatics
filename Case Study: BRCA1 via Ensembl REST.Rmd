...
library(jsonlite)  # JSON -> R objects
library(readr)     # read files (FASTA as plain text)
library(httr2)     # optional: R-side HTTP if you want
library(glue)      # string interpolation
library(dplyr)     # tidy data helpers
library(purrr)     # iterate safely
